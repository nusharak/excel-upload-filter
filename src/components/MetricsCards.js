    ...
    <>
      ...
      <Grid item xs={12} md={3}>
        <Box p={2} bgcolor="#f0f0f0" borderRadius="4px">
          ...
          <Typography variant="h6">{parseFloat(totalSums.refunds).toFixed(2)}</Typography>
        </Box>
      </Grid>
      <Grid item xs={12} md={3}>
        <Box p={2} bgcolor="#f0f0f0" borderRadius="4px">
          <Typography variant="body1">Total Cost:</Typography>
          <Typography variant="h6">{parseFloat(totalSums.totalCost).toFixed(2)}</Typography>
        </Box>
      </Grid>
      <Grid item xs={12} md={3}>
        <Box p={2} bgcolor="#f0f0f0" borderRadius="4px">
          <Typography variant="body1">Total Sales:</Typography>
          <Typography variant="h6">{parseFloat(totalSums.totalSales).toFixed(2)}</Typography>
        </Box>
      </Grid>
      <Grid item xs={12} md={3}>
        <Box p={2} bgcolor="#f0f0f0" borderRadius="4px">
          <Typography variant="body1">Total Net P/L:</Typography>
          <Typography variant="h6">{parseFloat(totalSums.netPL).toFixed(2)}</Typography>
        </Box>
      </Grid>
    </>
  );
